...
int DRsimDetectorConstruction::fNofCol = 1;
...
void DRsimDetectorConstruction::FiberImplement(
  ...
  int NofPlate = fModuleH / (fFiber_vert_dis) - 1;
  ...
  G4VSolid *space = new G4Box("glue2", (1.44 / 2.) * mm,
                    (30. / 2.) * mm, (320. / 2.) * mm);
  spaceLogical = new G4LogicalVolume(space, FindMaterial("G4_Galactic"),
                                     "spaceLogical"+std::to_string(i));
  G4VPhysicalVolume *spacePhysical =
      new G4PVPlacement(0, G4ThreeVector(13.78*mm,0.,0.), spaceLogical, "spacePhysical"+std::to_string(i), ModuleLogical__[i], false, 0, checkOverlaps);
...
logicAir2 -> SetVisAttributes(fVisAttrBlue);     
  ...
  G4VSolid *space3 = new G4Box("glue4", (0.233/ 2.) * mm,
                    (0.175 / 2.) * mm, (320. / 2.) * mm);
  ...
  G4VSolid *space2 = new G4Box("glue3", (0.233/ 2.) * mm,
                    (0.3 / 2.) * mm, (320. / 2.) * mm);
