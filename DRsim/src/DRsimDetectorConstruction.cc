...
//  fFiber_vert_dis = 1.22 + 0.0626;
  ...
  fiberUnit = new G4Box("fiber_SQ", (fFiberUnitH / 2) * mm, (1. / 2) * mm,
                        (fTowerDepth / 2) * mm);
  fiberClad = new G4Tubs("fiber", 0, clad_S_rMax, fTowerDepth  / 2.,
                         0 * deg, 360. * deg);
  fiberClad2 = new G4Tubs("fiber2", 0, clad_S_rMax2, fTowerDepth  / 2.,
                         0 * deg, 360. * deg);
  fiberCoreS = new G4Tubs("fiberS", 0, core_S_rMax, fTowerDepth  / 2.,
                          0 * deg, 360. * deg);
