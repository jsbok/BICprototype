...
if (file6==1) {
    RootInterface<koBICInterface::koBICEventData>* drInterface6 = new RootInterface<koBICInterface::koBICEventData>(std::string(filename6 + ".root"), true);
  drInterface6->set("koBIC","koBICEventData");
