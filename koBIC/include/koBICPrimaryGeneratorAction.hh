#ifndef koBICPrimaryGeneratorAction_h
#define koBICPrimaryGeneratorAction_h 1
...
class koBICPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction {
public:
  koBICPrimaryGeneratorAction(G4int seed, G4bool useHepMC, G4bool useCalib, G4bool useGPS);
  virtual ~koBICPrimaryGeneratorAction();
