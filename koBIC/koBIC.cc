...
int main(int argc, char** argv) {
  ...
  runManager->SetUserInitialization(new koBICDetectorConstruction());
  ...
  opticalParameters->SetScintByParticleType(false);
  ...
  runManager->SetUserInitialization(new koBICActionInitialization(seed,filename));
