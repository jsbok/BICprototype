...
koBICCellParameterisation::koBICCellParameterisation(const G4int numx, const G4int numy, const G4double moduleH, const G4double moduleW)
...
koBICCellParameterisation::~koBICCellParameterisation()
{}

void koBICCellParameterisation::ComputeTransformation(const G4int copyNo, G4VPhysicalVolume* physVol) const {
